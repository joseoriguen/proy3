        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <div id="page-content">
					...
					<!-- ==================================================================== -->
					            <div class='col-xs-6'>  
                <h3>Consulta Dinamica Personas</h3>
            </div>
            <br>
             ...
             <form>
              ...
              <div class="form-group" id="DivSel2">
                <label for="Tablas">Tablas:</label>
                 <select name="tablasSel2" id="tablasSel2">
                 <option value="seleccion">Seleccione una Consulta</option> 
